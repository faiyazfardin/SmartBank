...
// Session Configuration (5 minutes inactivity timeout for Vault and security sessions)
builder.Services.AddSession(options =>
{
    options.IdleTimeout = TimeSpan.FromMinutes(5);
    options.Cookie.HttpOnly = true;
    options.Cookie.IsEssential = true;
    options.Cookie.Name = "SmartBank.VaultSession";
...
using (var scope = app.Services.CreateScope())
{
    ...
    try
    {
        ...
        try
        {
            ...
            await context.Database.ExecuteSqlRawAsync("ALTER TABLE \"Users\" ADD COLUMN IF NOT EXISTS \"VaultPasswordHash\" text;");
            await context.Database.ExecuteSqlRawAsync("ALTER TABLE \"Users\" ADD COLUMN IF NOT EXISTS \"VaultPasswordSetAt\" timestamp with time zone;");
            await context.Database.ExecuteSqlRawAsync("ALTER TABLE \"Users\" ADD COLUMN IF NOT EXISTS \"FailedVaultAttempts\" integer NOT NULL DEFAULT 0;");
            await context.Database.ExecuteSqlRawAsync("ALTER TABLE \"Users\" ADD COLUMN IF NOT EXISTS \"VaultLockedUntil\" timestamp with time zone;");
            await context.Database.ExecuteSqlRawAsync("ALTER TABLE \"Users\" ADD COLUMN IF NOT EXISTS \"IsFirstLogin\" boolean NOT NULL DEFAULT TRUE;");
            await context.Database.ExecuteSqlRawAsync("ALTER TABLE \"Users\" ADD COLUMN IF NOT EXISTS \"LastVaultUnlockAt\" timestamp with time zone;");
            ...
            await context.Database.ExecuteSqlRawAsync(@"
                ...
                -- Loan Applications Repayment Extended Columns
                ALTER TABLE ""LoanApplications"" ADD COLUMN IF NOT EXISTS ""ApprovedAmount"" numeric(18,2);
                ALTER TABLE ""LoanApplications"" ADD COLUMN IF NOT EXISTS ""FinalInterestRate"" numeric(5,2);
                ALTER TABLE ""LoanApplications"" ADD COLUMN IF NOT EXISTS ""FinalTenureMonths"" integer;
                ALTER TABLE ""LoanApplications"" ADD COLUMN IF NOT EXISTS ""FinalEmi"" numeric(18,2);
                ALTER TABLE ""LoanApplications"" ADD COLUMN IF NOT EXISTS ""TotalRepayable"" numeric(18,2);
                ALTER TABLE ""LoanApplications"" ADD COLUMN IF NOT EXISTS ""IndicativeRate"" numeric(5,2);
                ALTER TABLE ""LoanApplications"" ADD COLUMN IF NOT EXISTS ""RequestedTenureMonths"" integer;
                ALTER TABLE ""LoanApplications"" ADD COLUMN IF NOT EXISTS ""FirstInstallmentDate"" timestamp with time zone;
                ALTER TABLE ""LoanApplications"" ADD COLUMN IF NOT EXISTS ""DisbursedAt"" timestamp with time zone;

                -- Loan Installments Table
                CREATE TABLE IF NOT EXISTS ""LoanInstallments"" (
                    ""Id"" integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
                    ""LoanApplicationId"" integer NOT NULL REFERENCES ""LoanApplications""(""Id"") ON DELETE CASCADE,
                    ...
                    ""Status"" character varying(50) NOT NULL DEFAULT 'Pending',
                    ""PaidAmount"" numeric(18,2) NOT NULL DEFAULT 0.00,
                    ""PaidAt"" timestamp with time zone,
                    ""PaymentMethod"" character varying(50),
                    ""TransactionReference"" character varying(100),
                    ""LateFeeApplied"" numeric(18,2) NOT NULL DEFAULT 0.00
                );
                CREATE INDEX IF NOT EXISTS ""IX_LoanInstallments_LoanApplicationId"" ON ""LoanInstallments""(""LoanApplicationId"");
                CREATE INDEX IF NOT EXISTS ""IX_LoanInstallments_DueDate_Status"" ON ""LoanInstallments""(""DueDate"", ""Status"");

                -- Loan Payments Table
                CREATE TABLE IF NOT EXISTS ""LoanPayments"" (
                    ""Id"" integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
                    ""LoanApplicationId"" integer NOT NULL REFERENCES ""LoanApplications""(""Id"") ON DELETE CASCADE,
                    ""InstallmentId"" integer REFERENCES ""LoanInstallments""(""Id"") ON DELETE SET NULL,
                    ""Amount"" numeric(18,2) NOT NULL,
                    ""PaymentDate"" timestamp with time zone NOT NULL DEFAULT CURRENT_TIMESTAMP,
                    ""Method"" character varying(50) NOT NULL DEFAULT 'AccountDebit',
                    ""ReferenceNumber"" character varying(100) NOT NULL,
                    ""RecordedBy"" character varying(100) NOT NULL DEFAULT 'SYSTEM',
                    ""Notes"" character varying(1000)
                );
                CREATE UNIQUE INDEX IF NOT EXISTS ""IX_LoanPayments_ReferenceNumber"" ON ""LoanPayments""(""ReferenceNumber"");
                CREATE INDEX IF NOT EXISTS ""IX_LoanPayments_LoanApplicationId"" ON ""LoanPayments""(""LoanApplicationId"");
                CREATE INDEX IF NOT EXISTS ""IX_LoanPayments_InstallmentId"" ON ""LoanPayments""(""InstallmentId"");

                -- Loan Rate Policies Table
                CREATE TABLE IF NOT EXISTS ""LoanRatePolicies"" (
                    ""Id"" integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
                    ""Category"" character varying(50) NOT NULL,
                    ""MinScore"" integer NOT NULL,
                    ""MaxScore"" integer NOT NULL,
                    ""BaseAnnualRate"" numeric(5,2) NOT NULL,
                ...
                CREATE TABLE IF NOT EXISTS ""LoanAuditLogs"" (
                    ""Id"" integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
                    ""LoanApplicationId"" integer NOT NULL REFERENCES ""LoanApplications""(""Id"") ON DELETE CASCADE,
                    ""Action"" character varying(100) NOT NULL,
                    ""FieldChanged"" character varying(100),
                ...
                CREATE INDEX IF NOT EXISTS ""IX_LoanAuditLogs_LoanApplicationId_PerformedAt"" ON ""LoanAuditLogs""(""LoanApplicationId"", ""PerformedAt"");

                -- Seed Loan Rate Policies if empty
                INSERT INTO ""LoanRatePolicies"" (""Category"", ""MinScore"", ""MaxScore"", ""BaseAnnualRate"", ""MinTenureMonths"", ""MaxTenureMonths"", ""IsActive"", ""EffectiveFrom"")
                SELECT 'Excellent', 80, 100, 8.00, 6, 60, TRUE, CURRENT_TIMESTAMP
                WHERE NOT EXISTS (SELECT 1 FROM ""LoanRatePolicies"" WHERE ""Category"" = 'Excellent');

                INSERT INTO ""LoanRatePolicies"" (""Category"", ""MinScore"", ""MaxScore"", ""BaseAnnualRate"", ""MinTenureMonths"", ""MaxTenureMonths"", ""IsActive"", ""EffectiveFrom"")
                SELECT 'Good', 65, 79, 10.50, 6, 48, TRUE, CURRENT_TIMESTAMP
                WHERE NOT EXISTS (SELECT 1 FROM ""LoanRatePolicies"" WHERE ""Category"" = 'Good');

                INSERT INTO ""LoanRatePolicies"" (""Category"", ""MinScore"", ""MaxScore"", ""BaseAnnualRate"", ""MinTenureMonths"", ""MaxTenureMonths"", ""IsActive"", ""EffectiveFrom"")
                SELECT 'ReviewRequired', 50, 64, 13.00, 6, 36, TRUE, CURRENT_TIMESTAMP
                WHERE NOT EXISTS (SELECT 1 FROM ""LoanRatePolicies"" WHERE ""Category"" = 'ReviewRequired');
            ");
        }
        catch (Exception ex)
        {
        ...
        {
            if (!adminUser.IsEmailVerified || adminUser.IsFirstLogin || adminUser.MustChangePasswordOnNextLogin)
            {
                adminUser.IsEmailVerified = true;
                adminUser.EmailVerifiedAt = DateTime.UtcNow;
                adminUser.IsFirstLogin = false;
                adminUser.MustChangePasswordOnNextLogin = false;
                await context.SaveChangesAsync();
            }
        }

        // Seeder for existing customer users: Set default VaultPasswordHash to "password" and IsFirstLogin = true
        var usersNeedingVaultSeed = await context.Users.Where(u => u.VaultPasswordHash == null && u.Role != "Admin").ToListAsync();
        if (usersNeedingVaultSeed.Any())
        {
            var defaultVaultHash = PasswordHasher.HashPassword("password");
            foreach (var u in usersNeedingVaultSeed)
            {
                u.VaultPasswordHash = defaultVaultHash;
                u.VaultPasswordSetAt = DateTime.UtcNow;
                u.IsFirstLogin = true;
                u.MustChangePasswordOnNextLogin = true;
                u.FailedVaultAttempts = 0;
