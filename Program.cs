    ...
    try
    {
        ...
        try
        {
            ...
            await context.Database.ExecuteSqlRawAsync(@"
                ...
                CREATE INDEX IF NOT EXISTS ""IX_OtpChallenges_UserId_Purpose_ReferenceId"" ON ""OtpChallenges""(""UserId"", ""Purpose"", ""ReferenceId"");
                ...
                CREATE TABLE IF NOT EXISTS ""TransferRequests"" (
                    ...
                    ""OtpChallengeId"" integer REFERENCES ""OtpChallenges""(""Id"") ON DELETE SET NULL,
                    ""CreatedAt"" timestamp with time zone NOT NULL DEFAULT CURRENT_TIMESTAMP,
                    ""ExpiresAt"" timestamp with time zone NOT NULL,
